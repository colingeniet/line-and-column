...
public:
    ...
    */
    ...
    /*!
    * @brief Accessors for a specific form
    *
    * @return Form wanted in the form set
    *
    */
    Form getform(size_t) const;
    /*!
    * @brief Accessors for a specific form's color
    *
    * @return Form's color
    *
    */
...
private:
    ...
    std::vector<Form> form_set;                 /*!< Form set */
    std::vector<unsigned int> form_weight;      /*!< Weight in random selection (weight aren't a part of each form but they are an external parameter) */
    std::vector<int> form_color;                /*!< Color (colors aren't a part of each form but they are an external parameter) */
